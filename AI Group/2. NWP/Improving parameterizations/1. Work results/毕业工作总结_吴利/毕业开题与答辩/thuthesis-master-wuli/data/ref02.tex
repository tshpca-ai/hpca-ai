...
地球系统模式由动力框架和物理参数化方案组成，其中动力框架用来表示网格间的能量和物质交换等，而物理参数化方案用来表示分辨率以下的
而在参数化方案中有许多由专家根据经验设置的物理参数，例如在对流方案中的等。

另外通常在地球系统模式的优化之前会对不确定性参数做采样和敏感性分析，先对模式的参数空间有一个大概的认识。代理模式可以更全面的利用这些珍贵的采样样本。
